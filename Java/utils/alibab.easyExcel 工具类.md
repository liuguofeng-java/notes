...
public class ExcelModel extends BaseRowModel implements Serializable {
    ...
    @ExcelProperty(value = "症状",index = 2)
    private String symptom;

    @ExcelProperty(value = "体温",index = 3)
...
public void dome1(){
    try {
        InputStream inputStream=new FileInputStream("C:\\Users\\Lenovo\\Desktop\\text.xlsx");
...
//写
@Test
public void dome2() throws FileNotFoundException {
    List<ExcelModel> excelModelList = new ArrayList<>();
    for (int i = 0; i < 100000; i++) {
        ExcelModel excelModel = new ExcelModel();
        excelModel.setId(i+"");
        excelModel.setName("tom");
        excelModel.setSymptom("发烧");
        excelModel.setAnimalHeat("37.8");
        excelModel.setStatus("安全");
        excelModel.setStartDate(new Date());
        excelModelList.add(excelModel);
    }

    long beginTime = System.currentTimeMillis();
    OutputStream out = new FileOutputStream("C:\\Users\\Lenovo\\Desktop\\aaa.xlsx");
