...
创建log4j2.xml文件，放在工程resources目录里。这样就可以不加任何配置。
...
<configuration monitorInterval="5">
    ...
    <Properties>
        ...
        -->
        <property name="LOG_PATTERN" value="%d{yyyy-MM-dd HH:mm:ss.SSS} %highlight{%-5level}[%thread] %style{%logger{36}}{cyan} %msg%xEx %n" />
...
如果你需要指定配置文件需要在Spring boot 配置文件application.properties中指定 logging.config 属性。
