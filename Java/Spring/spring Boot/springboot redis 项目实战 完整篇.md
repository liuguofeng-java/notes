...
![](../../../assets/1659272790653.webp)

redis构建的相关目录.png

3.在application.yml中配置redis参数

![](../../../assets/1659272790678.webp)
...
用的Postman工具测试，也可以用浏览器或其他工具测试。

postman具体使用参考网上资源，很简单的。

![](../../../assets/1659272790695.webp)

使用工具测试.png

返回：true 代表向redis中存成功

9.用RedisDesktopManager工具查看

没有下载安装的，可以用命令行的方式，根据key值查找。

![](../../../assets/1659272790711.webp)

打开Redis Desktop Manager工具.png

kay：id

value：123456

过期时间，默认-1，-1代表永远，不会过期

设置过期，可以找RedisUtil.java类中的相关方法

追加更新说明：

问题：RedisUtil.java工具类报找不到 Status 类的错误：Status .java

解决方式：将Status .java类，放到项目任意位置，重新引入此类
